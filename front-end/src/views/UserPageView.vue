      ...
      >
        <template #default>
          ...
          <div class="info">
            ...
            <Tags id="user-tag" :radius="'50px'" :tag-groups=tagGroup :tags-color=tagsColor
                  :tags-font-size="'20px'"></Tags>
          </div>
        </template>
...
function introductionAnimation() {
  ...
  if (introduction.value.length > 10) {
    ...
    setTimeout(() => {
      ...
      if (introduction.value.length > 25) introduction.value = introduction.value.substring(0, 25)
      introduction.value = introduction.value.substring(0, introduction.value.length - 1)
      introductionAnimation()
    }, 90)
